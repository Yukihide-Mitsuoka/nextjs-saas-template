...
This template's worked example module is `src/modules/identity/` — imitate its shape
(COD-050). Run `make doctor` anytime to self-check the template (frontmatter integrity +
guard-hook tests).
